...
import { CalendarCheck2, Loader2, Plus, Users } from 'lucide-react';
...
export function CourseAttendanceTab({ courseId }: CourseAttendanceTabProps) {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Nao foi possivel carregar os registros de presenca deste curso.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  const saveAttendance = async () => {
    ...
    try {
      ...
      toast({
        title: 'Erro ao salvar presencas',
        description: 'Nao foi possivel salvar os registros da chamada.',
        variant: 'destructive',
      });
    } finally {
      setIsSaving(false);
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between gap-3">
            <div>
              <CardTitle className="text-base">Registros de presenca</CardTitle>
              <CardDescription>Historico das chamadas desta disciplina</CardDescription>
            </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
                <DialogHeader>
                  <DialogTitle>Lancar presenca</DialogTitle>
                  <DialogDescription>Registre a presenca dos alunos para uma data.</DialogDescription>
                </DialogHeader>
                            ...
                            <TableRow key={student.id}>
                              ...
                              <TableCell>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    <SelectItem value={STATUS_NONE}>Nao informado</SelectItem>
        ...
        <CardContent>
          {groupedByDate.length === 0 ? (
            <div className="py-10 text-center space-y-2">
              ...
              <p className="font-medium">Nenhum registro de presenca ainda.</p>
            </div>
          ) : (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Ultimos lancamentos realizados</CardDescription>
        </CardHeader>
