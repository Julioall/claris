-- Students listed in the app must follow the same "Meus Cursos" scope as the
-- dashboard: only courses explicitly followed by the user as tutor are counted.
...
GRANT EXECUTE ON FUNCTION public.list_students_paginated(UUID, TEXT, TEXT, TEXT, INTEGER, INTEGER) TO authenticated;
