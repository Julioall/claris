...
CREATE INDEX IF NOT EXISTS idx_student_courses_course_student
...
CREATE INDEX IF NOT EXISTS idx_student_activities_course_student_status
...
CREATE INDEX IF NOT EXISTS idx_bulk_message_recipients_job_status
...
CREATE INDEX IF NOT EXISTS idx_student_sync_snapshots_student_synced
