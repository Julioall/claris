...
export const BULK_JOB_STATUSES = ['pending', 'processing', 'completed', 'failed', 'cancelled'] as const
export const BULK_RECIPIENT_STATUSES = ['pending', 'sent', 'failed'] as const
export const SCHEDULED_MESSAGE_STATUSES = ['pending', 'paused', 'processing', 'sent', 'failed', 'cancelled'] as const

export type BulkJobStatusDto = typeof BULK_JOB_STATUSES[number]
export type BulkRecipientStatusDto = typeof BULK_RECIPIENT_STATUSES[number]
export type ScheduledMessageStatusDto = typeof SCHEDULED_MESSAGE_STATUSES[number]
