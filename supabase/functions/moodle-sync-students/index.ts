...
import { validateMoodleUrl, validateString, validatePositiveInteger } from '../_shared/validation.ts'
import { getCourseEnrolledUsers } from '../_shared/moodle-client.ts'
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.error('Error in moodle-sync-students:', error)
